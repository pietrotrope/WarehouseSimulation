...
def main(task_number):
    ...
    name_ga = "".join(["random0_", str(task_number), ".csv"])
    t = time()
    ...
    with open(name_ga, 'a') as f:
        ...
        for seed_i in range(start, 20):
            ...
            e.task_handler.TA_random_scheduling_initialization()
            res = e.new_simulation(task_number, scheduling=e.task_handler.scheduling)
